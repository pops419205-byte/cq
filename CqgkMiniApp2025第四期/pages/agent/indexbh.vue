	...
	export default {
		...
		methods: {   
			...
			infoBtn(num){  
				 ...
				 // if(this.tabIndex==1)url = this.$Router.agent.Invoiced +'?FWORDERNO='+num+'&tabIndex='+this.tabIndex;
				 
				let url = this.$Router.agent.Replenish +'?FWORDERNO='+num+'&tabIndex='+this.tabIndex;
				if(this.tabIndex==1)url = this.$Router.agent.Replenished +'?FWORDERNO='+num+'&tabIndex='+this.tabIndex;
